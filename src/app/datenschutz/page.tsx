...
import { 
  ...
  Server, Globe, FileCheck, Mail, Menu 
} from "lucide-react";
          ...
          >
            ...
            <motion.div variants={fadeIn} className="text-left space-y-4">
              ...
              <p className="text-xl text-slate-600 max-w-2xl leading-relaxed mb-12">
                Transparente Informationen darüber, wie wir deine Daten beim Dart Masters Puschendorf im Rahmen der DSGVO erheben, verarbeiten und schützen.
              </p>
            </motion.div>
